...
const translations: Record<string, { en: string; vi: string }> = {
  ...
  statsFinesTab: { en: "Fines", vi: "Phạt" },
  clientMemberHistoryCount: { en: "{count} tier changes", vi: "{count} lần đổi hạng" },
  memberNextTierLabel: { en: "Next tier", vi: "Hạng tiếp theo" },
  memberNextTierRemaining: { en: "coins to go", vi: "coin nữa" },
  memberNextTierMax: { en: "Top tier reached", vi: "Đã ở hạng cao nhất" },
