...
const translations: Record<string, { en: string; vi: string }> = {
  ...
  // Analytics
  ownerAnalyticsTitle: { en: "Owner analytics", vi: "Phân tích hệ thống" },
  ownerAnalyticsDesc: { en: "Switch between payment, usage, and review tabs for the owner view.", vi: "Chuyển giữa các tab thanh toán, sử dụng và kiểm tra cho chế độ xem chủ sở hữu." },
  ...
  analyticsAirfryerTab: { en: "Airfryer usage", vi: "Sử dụng nồi chiên" },
  coinAnalyticsTitle: { en: "Coin analytics", vi: "Phân tích Coin" },
  coinAnalyticsDesc: { en: "Owner-only coin movement grouped by person, branch, event, and date.", vi: "Biến động coin chỉ dành cho chủ sở hữu, nhóm theo người, chi nhánh, sự kiện và ngày." },
  fineAnalyticsTitle: { en: "Fine analytics", vi: "Phân tích Tiền phạt" },
  fineAnalyticsDesc: { en: "Owner-only fine records grouped by branch, status, content, and date.", vi: "Hồ sơ tiền phạt chỉ dành cho chủ sở hữu, nhóm theo chi nhánh, trạng thái, nội dung và ngày." },
  laundryAnalyticsTitle: { en: "Laundry analytics", vi: "Phân tích Giặt sấy" },
  laundryAnalyticsDesc: { en: "Laundry bookings grouped by machine, branch, actor, and time.", vi: "Lịch đặt giặt sấy nhóm theo máy, chi nhánh, người thực hiện và thời gian." },
  ...
  analyticsGroupOrder: { en: "Group order", vi: "Thứ tự nhóm" },
  analyticsGroupOrderDesc: { en: "Change the order, then click through the chart from left to right.", vi: "Thay đổi thứ tự, sau đó nhấn vào biểu đồ từ trái sang phải." },
  analyticsBarChart: { en: "Bar chart", vi: "Biểu đồ cột" },
  analyticsDonutChart: { en: "Donut chart", vi: "Biểu đồ tròn" },
  analyticsDragToReorder: { en: "Drag to reorder this grouping step.", vi: "Kéo để thay đổi thứ tự bước nhóm này." },
  analyticsMoveUp: { en: "Move {label} up", vi: "Di chuyển {label} lên" },
  analyticsMoveDown: { en: "Move {label} down", vi: "Di chuyển {label} xuống" },
  analyticsRemoveDim: { en: "Remove {label}", vi: "Gỡ {label}" },
  analyticsAddGroup: { en: "Add group", vi: "Thêm nhóm" },
  analyticsAllEntries: { en: "All entries", vi: "Tất cả mục" },
  analyticsAllReceipts: { en: "All receipts", vi: "Tất cả biên lai" },
  analyticsAllCoinEntries: { en: "All coin entries", vi: "Tất cả mục coin" },
  analyticsAllFineEntries: { en: "All fine entries", vi: "Tất cả mục phạt" },
  analyticsAllLaundryUses: { en: "All laundry uses", vi: "Tất cả lượt giặt" },
  analyticsAllAirfryerUses: { en: "All airfryer uses", vi: "Tất cả lượt nồi chiên" },
  analyticsAllCleaningItems: { en: "All cleaning items", vi: "Tất cả mục vệ sinh" },
  analyticsBackToChart: { en: "Back to chart", vi: "Quay lại biểu đồ" },
  analyticsEmptyCoin: { en: "No coin rows available yet. Refresh to sync the coin sheet.", vi: "Chưa có dữ liệu coin. Làm mới để đồng bộ từ sheet coin." },
  analyticsEmptyFine: { en: "No fine rows available yet. Refresh to sync the fine sheet.", vi: "Chưa có dữ liệu tiền phạt. Làm mới để đồng bộ từ sheet tiền phạt." },
  analyticsEmptyLaundry: { en: "No laundry usage has been recorded yet.", vi: "Chưa có dữ liệu sử dụng giặt sấy." },
  analyticsEmptyAirfryer: { en: "No airfryer usage has been recorded yet.", vi: "Chưa có dữ liệu sử dụng nồi chiên." },
  analyticsEmptyCleaning: { en: "No cleaning review items are available yet.", vi: "Chưa có mục kiểm tra vệ sinh nào." },
  analyticsEmptyPayment: { en: "No payment cache is loaded yet. Refresh payments to sync the receipt sheet.", vi: "Chưa tải bộ nhớ đệm thanh toán. Làm mới để đồng bộ từ sheet biên lai." },
  // Dimensions
  dimReceiver: { en: "Receiver", vi: "Người nhận" },
  dimBranch: { en: "Branch", vi: "Chi nhánh" },
  dimCategory: { en: "Category", vi: "Danh mục" },
  dimBed: { en: "Bed", vi: "Giường" },
  dimYear: { en: "Year", vi: "Năm" },
  dimMonth: { en: "Month", vi: "Tháng" },
  dimActor: { en: "Actor", vi: "Người thực hiện" },
  dimEvent: { en: "Event", vi: "Sự kiện" },
  dimStatus: { en: "Status", vi: "Trạng thái" },
  ...
  revenueInView: { en: "Revenue in view", vi: "Doanh thu đang xem" },
  paymentEntries: { en: "Payment entries", vi: "Các mục thanh toán" },
  // Fine Ticket creation labels (from fineFieldLabels)
  fineFieldDueDate: { en: "Payment Due Date", vi: "Hạn thanh toán" },
  fineFieldEventDateTime: { en: "Date & time of violation", vi: "Thời điểm vi phạm" },
  fineFieldEventDateTimeHint: { en: "When the incident occurred. Leave blank to use the time you submit the ticket.", vi: "Ngày giờ sự việc xảy ra. Để trống để dùng thời điểm tạo phiếu." },
  fineFieldLocation: { en: "Violation Location", vi: "Vị trí phát hiện vi phạm" },
  fineFieldContent: { en: "Violation Content", vi: "Nội dung vi phạm" },
  fineFieldDescription: { en: "Violation Description", vi: "Mô tả vi phạm" },
  fineFieldEvidence: { en: "Photo / video evidence", vi: "Ảnh / video minh chứng" },
  fineFieldAmount: { en: "Violation Payment Cost", vi: "Chi phí thanh toán vi phạm" },
  fineFieldEvidencePlaceholder: { en: "Paste evidence URL", vi: "Dán liên kết minh chứng" },
  fineFieldSubmit: { en: "Create fine ticket", vi: "Tạo phiếu phạt" },
  // Table Columns
  colWhen: { en: "When", vi: "Thời gian" },
  ...
  colMachine: { en: "Machine", vi: "Máy" },
  colDetails: { en: "Details", vi: "Chi tiết" },
  colResident: { en: "Resident", vi: "Khách hàng" },
  colDetail: { en: "Detail", vi: "Chi tiết" },
  // Management & UI
  loadingInactiveClients: { en: "Loading inactive clients…", vi: "Đang tải danh sách khách cũ…" },
  hostelPortalTitle: { en: "Hostel Portal", vi: "Quản lý Hostel" },
  ...
  noPastShortStayRecords: { en: "No past short-stay records found.", vi: "Không tìm thấy hồ sơ lưu trú cũ." },
  ...
  submittedAtWithDate: { en: "Submitted: {date}", vi: "Ngày gửi: {date}" },
  statusWithLabel: { en: "Status: {status}", vi: "Trạng thái: {status}" },
  missingIdentifierFixSheet: { en: "Missing identifier — fix manually in sheet", vi: "Thiếu mã định danh — hãy sửa thủ công trên sheet" },
  paymentPlanLabel: { en: "Payment Plan", vi: "Kế hoạch thanh toán" },
  ...
  loadingPreview: { en: "Loading preview…", vi: "Đang tải bản xem trước…" },
  residentWithLabel: { en: "Resident: ", vi: "Khách hàng: " },
  revenueLabel: { en: "Revenue", vi: "Doanh thu" },
  paymentDueLabel: { en: "Payment due", vi: "Đến hạn thanh toán" },
  packageExpiresLabel: { en: "Package expires: {date}", vi: "Gói hết hạn: {date}" },
  overdueSinceLabel: { en: "Overdue since", vi: "Quá hạn từ" },
  nextPaymentLabel: { en: "Next payment:", vi: "Thanh toán tiếp theo:" },
  checkedOutWithDate: { en: "Checked out — {date}", vi: "Đã trả phòng — {date}" },
  terminatedCheckOutPending: { en: "Terminated — check-out pending", vi: "Đã chấm dứt — chờ trả phòng" },
  contractStatusActive: { en: "Active", vi: "Đang hoạt động" },
  terminatedWithDate: { en: "Terminated {date}", vi: "Đã chấm dứt {date}" },
  terminateContractBtn: { en: "Terminate contract", vi: "Chấm dứt hợp đồng" },
  depositPolicyWarningTitle: { en: "⚠️ Important — deposit policy", vi: "⚠️ Quan trọng — chính sách tiền cọc" },
  terminateNotePlaceholder: { en: "e.g. No replacement found — deposit at risk", vi: "v.d. Không có người thay thế — rủi ro mất cọc" },
  confirmTerminationBtn: { en: "Confirm termination", vi: "Xác nhận chấm dứt" },
  processingLabel: { en: "Processing…", vi: "Đang xử lý…" },
  contractTerminatedStatus: { en: "Contract terminated. When eligible, check-out appears on their Home / Account and at /check-out.", vi: "Đã chấm dứt hợp đồng. Khi đủ điều kiện, nút trả phòng sẽ hiện ở Trang chủ / Tài khoản và tại /check-out." },
  depositRefundBtn: { en: "Deposit refund…", vi: "Hoàn tiền cọc…" },
  stayStatusNotSet: { en: "Not set — new registration", vi: "Chưa thiết lập — đăng ký mới" },
  stayStatusStaying: { en: "Currently staying", vi: "Đang lưu trú" },
  stayStatusMovedOut: { en: "Moved out (0)", vi: "Đã dời đi (0)" },
  stayStatusLeft: { en: "Left / removed (−1)", vi: "Đã rời đi (−1)" },
  depositRefundDesc: { en: "Shows deposit on file minus unpaid fines and gate parking tickets. You can change the refund amount before sending a bilingual notice (Vietnamese + English) to the resident.", vi: "Hiển thị tiền cọc trừ đi các khoản phạt chưa thanh toán và tiền gửi xe. Bạn có thể thay đổi số tiền hoàn lại trước khi gửi thông báo song ngữ cho khách." },
  roleManager: { en: "Manager", vi: "Quản lý" },
  roleMechanic: { en: "Mechanic", vi: "Kỹ thuật" },
  roleOwner: { en: "Owner", vi: "Chủ sở hữu" },
  errLoadController: { en: "Unable to load controller history", vi: "Không thể tải lịch sử thiết bị" },
  errLoadLaundry: { en: "Unable to load laundry history", vi: "Không thể tải lịch sử giặt sấy" },
  errLoadCleaning: { en: "Unable to load cleaning tasks", vi: "Không thể tải danh sách vệ sinh" },
  unknownLabel: { en: "Unknown", vi: "Không xác định" },
  systemLabel: { en: "System", vi: "Hệ thống" },
  uncategorizedLabel: { en: "Uncategorized", vi: "Chưa phân loại" },
  totalBookings: { en: "Total bookings", vi: "Tổng lượt đặt" },
  upcoming: { en: "Upcoming", vi: "Sắp tới" },
  completed: { en: "Completed", vi: "Đã hoàn thành" },
  nextBooking: { en: "Next booking", vi: "Lượt đặt tiếp theo" },
  noUpcomingBooking: { en: "No upcoming booking", vi: "Chưa có lượt đặt tiếp theo" },
  currentBalance: { en: "Current balance", vi: "Số dư hiện tại" },
  lifetimeCoins: { en: "Lifetime coins", vi: "Tổng coin tích lũy" },
  coinsAdded: { en: "Coins added", vi: "Coin đã cộng" },
  coinsUsed: { en: "Coins used", vi: "Coin đã dùng" },
  paymentCount: { en: "Payment count", vi: "Số lần thanh toán" },
  totalPaid: { en: "Total paid", vi: "Tổng đã thanh toán" },
  averagePayment: { en: "Average payment", vi: "Thanh toán trung bình" },
  latestPayment: { en: "Latest payment", vi: "Thanh toán gần nhất" },
  noPaymentsYet: { en: "No payments yet", vi: "Chưa có thanh toán" },
  fineCount: { en: "Fine count", vi: "Số lần phạt" },
  unpaidFines: { en: "Unpaid fines", vi: "Tiền phạt chưa đóng" },
  totalFineValue: { en: "Total fine value", vi: "Tổng tiền phạt" },
  nearestDueDate: { en: "Nearest due date", vi: "Hạn đóng gần nhất" },
  noDueDate: { en: "No due date", vi: "Không có hạn đóng" },
  coinEntries: { en: "Coin entries", vi: "Mục coin" },
  latestActivity: { en: "Latest activity", vi: "Hoạt động gần nhất" },
  noCoinHistoryYet: { en: "No coin history yet", vi: "Chưa có lịch sử coin" },
  fineEntries: { en: "Fine entries", vi: "Mục phạt" },
  latestFine: { en: "Latest fine", vi: "Phạt gần nhất" },
  noFineHistoryYet: { en: "No fine history yet", vi: "Chưa có lịch sử phạt" },
  usageCount: { en: "Usage count", vi: "Số lần sử dụng" },
  branches: { en: "Branches", vi: "Chi nhánh" },
  topBranch: { en: "Top branch", vi: "Chi nhánh dùng nhiều nhất" },
  noBranchYet: { en: "No branch yet", vi: "Chưa có chi nhánh" },
  latestUse: { en: "Latest use", vi: "Dùng gần nhất" },
  noUsageYet: { en: "No usage yet", vi: "Chưa có dữ liệu" },
  emailLabel: { en: "Email", vi: "Email" },
  colBed: { en: "Bed", vi: "Giường" },
  analyticsEntriesWithCount: { en: "{count} entries", vi: "{count} mục" },
  analyticsPaymentsWithCount: { en: "{count} payment entries", vi: "{count} thanh toán" },
  revenueLabel: { en: "Revenue", vi: "Doanh thu" },
  noValueLabel: { en: "-", vi: "-" },
  paymentRevenueDonutChart: { en: "Payment revenue donut chart", vi: "Biểu đồ doanh thu" },
  donutChartWithTitle: { en: "{title} donut chart", vi: "Biểu đồ {title}" },
  clientsTab: { en: "Clients", vi: "Khách hàng" },
  finesTab: { en: "Fines", vi: "Tiền phạt" },
  paymentsTab: { en: "Payments", vi: "Thanh toán" },
  cleaningTab: { en: "Cleaning schedule", vi: "Lịch vệ sinh" },
  laundryTab: { en: "Laundry", vi: "Giặt sấy" },
  supportTab: { en: "Support / Messages", vi: "Hỗ trợ / Tin nhắn" },
  coinsTab: { en: "Coins", vi: "Coin" },
  statsTab: { en: "Statistics", vi: "Thống kê" },
  baseRent: { en: "Base rent", vi: "Tiền phòng cơ bản" },
  monthlyAdjustmentSurcharge: { en: "Monthly adjustment surcharge", vi: "Phụ phí điều chỉnh" },
  monthlyAdjustmentDiscount: { en: "Monthly adjustment discount", vi: "Giảm giá điều chỉnh" },
  planDiscount: { en: "Plan discount", vi: "Giảm giá gói" },
  managerDiscount: { en: "Manager discount", vi: "Giảm giá từ quản lý" },
  parkingFee: { en: "Parking (sheet)", vi: "Tiền gửi xe" },
  gateParkingFee: { en: "Gate parking (unpaid tickets)", vi: "Tiền gửi xe (vãng lai)" },
  billBeforeCoin: { en: "Bill before coin credit", vi: "Tổng hóa đơn (trước dùng coin)" },
  analyticsPaymentsWithCountShort: { en: "{count} payments", vi: "{count} thanh toán" },
  tenureSurcharge: { en: "Short-term surcharge", vi: "Phụ phí ngắn hạn" },
  laundryServices: { en: "Laundry", vi: "Giặt sấy" },
  unpaidFinesLabel: { en: "Fines (unpaid, sheet)", vi: "Tiền phạt (chưa đóng, từ bảng tính)" },
  coinsExchangedDesc: { en: "Coins exchanged for this bill: {coins} coins (≈ {value} VND)", vi: "Coin đã quy đổi cho hóa đơn này: {coins} coin (≈ {value} VND)" },
  gateParkingFeeDetail: { en: "Gate parking (unpaid tickets before billing month)", vi: "Tiền gửi xe (vãng lai trước tháng này)" },
  laundryPriorMonthDetail: { en: "Laundry — prior month {month} ({count} cash)", vi: "Giặt sấy — tháng trước {month} ({count} lượt tiền mặt)" },
  helpContractStatus: { 
    en: "Contract Status lets a manager see whether the resident is active, terminated, or already checked out.\n\nThis aligns with Cozorohome policy by making termination and check-out steps explicit before access or deposit decisions are changed.",
    vi: "Trạng thái hợp đồng giúp quản lý biết cư dân đang hoạt động, đã chấm dứt hay đã trả phòng.\n\nĐiều này phù hợp với chính sách Cozorohome bằng cách làm rõ các bước chấm dứt và trả phòng trước khi thay đổi quyết định về truy cập hoặc tiền cọc."
  },
  helpMonthlyRent: {
    en: "Monthly Rent is collapsed by default. Expand to see line items (zeros are shown). The gate parking line sums unpaid gate parking tickets (managed under Client Actions) until rent is paid. Laundry uses cash washes from the previous calendar month; unpaid fines from the sheet are included until settled.\n\nThis aligns with Cozorohome policy by separating recurring rent from prior-period usage and ticketed gate charges.",
    vi: "Tiền thuê hàng tháng mặc định được thu gọn. Mở rộng để xem các khoản mục (các khoản bằng 0 vẫn hiển thị). Dòng gửi xe vãng lai cộng dồn các vé chưa thanh toán (quản lý trong Mục Khác) cho đến khi tiền thuê được đóng. Giặt sấy tính các lượt giặt tiền mặt từ tháng trước; các phiếu phạt chưa đóng cũng được bao gồm cho đến khi tất toán.\n\nĐiều này phù hợp với chính sách Cozorohome bằng cách tách biệt tiền thuê định kỳ với các chi phí sử dụng kỳ trước và phí gửi xe vãng lai."
  },
  helpFeatureLock: {
    en: "Feature Lock controls whether the resident follows the normal automatic restriction rules or has a temporary manager override.\n\nThis aligns with Cozorohome policy by keeping overdue-rent and expired-contract restrictions automatic unless a manager intentionally unlocks access.",
    vi: "Khóa tính năng kiểm soát việc cư dân tuân theo các quy tắc hạn chế tự động thông thường hay có sự ghi đè tạm thời của quản lý.\n\nĐiều này phù hợp với chính sách Cozorohome bằng cách giữ cho các hạn chế do nợ tiền thuê hoặc hết hạn hợp đồng là tự động, trừ khi quản lý chủ động mở khóa."
  },
  helpClientActions: {
    en: "Client Actions are the manager-side tools for calling, messaging, fines, coins, gate parking tickets, password support, and receipt creation.\n\nThis aligns with Cozorohome policy by keeping resident support actions inside tracked manager workflows instead of unrecorded side actions.",
    vi: "Mục Khác là các công cụ dành cho quản lý để gọi điện, nhắn tin, phạt, cộng/trừ coin, vé gửi xe vãng lai, hỗ trợ mật khẩu và tạo biên lai.\n\nĐiều này phù hợp với chính sách Cozorohome bằng cách giữ cho các hành động hỗ trợ cư dân nằm trong quy trình quản lý được ghi lại, thay vì các hành động bên lề không được lưu vết."
  },
  howContractStatusWorks: { en: "How contract status works", vi: "Cách hoạt động của trạng thái hợp đồng" },
  contractStatusTitle: { en: "Contract Status", vi: "Trạng thái hợp đồng" },
  howMonthlyRentWorks: { en: "How monthly rent works", vi: "Cách hoạt động của tiền thuê" },
  monthlyRentTitle: { en: "Monthly Rent", vi: "Tiền thuê hàng tháng" },
  howFeatureLockWorks: { en: "How feature lock works", vi: "Cách hoạt động của khóa tính năng" },
  featureLockTitle: { en: "Feature Lock", vi: "Khóa tính năng" },
  howClientActionsWork: { en: "How client actions work", vi: "Cách hoạt động của Mục Khác" },
  clientActionsTitle: { en: "Client Actions", vi: "Mục Khác" },
  emailLabel: { en: "Email", vi: "Email" },
  phoneLabel: { en: "Phone", vi: "Số điện thoại" },
  loadingLabel: { en: "Loading...", vi: "Đang tải..." },
  featureLockOff: { en: "Feature Lock: Off", vi: "Khóa tính năng: Tắt" },
  ...
  stayStatusLabel: { en: "Stay Status", vi: "Trạng thái cư trú" },
  monthlyRentLabel: { en: "Monthly Rent", vi: "Tiền thuê hàng tháng" },
  noInactiveClients: { en: "No inactive clients found.", vi: "Không tìm thấy khách hàng cũ nào." },
  noClientsMatchFilters: { en: "No clients match the current filters.", vi: "Không có khách hàng nào khớp với bộ lọc." },
  noPreviewLoaded: { en: "No preview loaded.", vi: "Chưa tải bản xem trước." },
  noEngineEstimate: { en: "No engine estimate for this client or month.", vi: "Không có ước tính từ hệ thống cho khách hàng hoặc tháng này." },
  noBreakdownAvailable: { en: "No breakdown available", vi: "Không có bảng chi tiết" },
  noExistingValuesYet: { en: "No existing values yet", vi: "Chưa có giá trị nào" },
  noLongTermDiscounts: { en: "No long-term discounts configured.", vi: "Chưa cấu hình giảm giá dài hạn." },
  coinEvent_Laundry_reward: { en: "Laundry reward", vi: "Thưởng giặt sấy" },
  coinEvent_Cleaning_reward: { en: "Cleaning reward", vi: "Thưởng vệ sinh" },
  coinEvent_Referral_reward: { en: "Referral reward", vi: "Thưởng giới thiệu" },
  coinEvent_Manual_bonus: { en: "Manual bonus", vi: "Cộng coin thủ công" },
  coinEvent_Laundry_usage: { en: "Laundry usage", vi: "Sử dụng máy giặt" },
  coinEvent_Fine_payment: { en: "Fine payment", vi: "Thanh toán tiền phạt" },
  coinEvent_Member_upgrade: { en: "Member upgrade", vi: "Nâng cấp thành viên" },
  coinEvent_Manual_deduction: { en: "Manual deduction", vi: "Trừ coin thủ công" },
  searchOrTypeNew: { en: "Search or type new", vi: "Tìm hoặc nhập mới" },
  selectExistingOrTypeNew: { en: "Select existing or type new", vi: "Chọn có sẵn hoặc nhập mới" },
  parkingFeePlaceholder: { en: "Parking fee VND/month", vi: "Phí gửi xe VND/tháng" },
  resetToSheetPlaceholder: { en: "blank = reset to sheet", vi: "để trống = đặt lại theo bảng tính" }
