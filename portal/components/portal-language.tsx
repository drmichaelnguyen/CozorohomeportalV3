...
const translations: Record<string, { en: string; vi: string }> = {
  ...
  analyticsTab: { en: "Analytics", vi: "Phân tích" },
  ...
  editNextPaymentDateLabel: { en: "Next payment date", vi: "Ngày thanh toán tiếp theo" },
  saveNextPaymentDate: { en: "Save next payment date", vi: "Lưu ngày thanh toán tiếp theo" },
  nextPaymentDateUpdated: { en: "Next payment date updated.", vi: "Đã cập nhật ngày thanh toán tiếp theo." },
  savingLabel: { en: "Saving…", vi: "Đang lưu…" },
