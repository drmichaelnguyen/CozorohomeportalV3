...
export function SupportClient() {
  ...
  return (
    <div className="flex h-[calc(100vh-140px)] min-h-0 flex-col overflow-hidden bg-white md:h-[700px] md:rounded-3xl md:border md:border-slate-200 md:shadow-lg">
      ...
      {/* Header */}
      <header className="shrink-0 border-b border-slate-100 bg-white/80 px-3 py-2.5 backdrop-blur-md md:px-4 md:py-3">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h1 className="text-base font-bold text-slate-900 md:text-lg">{t("residentMessages", "Messages")}</h1>
            <p className="hidden text-[10px] font-bold uppercase tracking-wider text-slate-400 sm:block">
              {activeTab === "personal" ? t("cozoroSupport", "Cozoro Support") : `${activeTab} ${t("community", "Community")}`}
            </p>
          </div>
        ...
        <div className="mt-2 flex gap-1 overflow-x-auto pb-1 no-scrollbar">
          <button
            ...
            className={`whitespace-nowrap rounded-full px-2.5 py-1 text-[11px] font-bold transition-all ${
